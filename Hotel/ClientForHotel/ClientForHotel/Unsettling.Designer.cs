namespace ClientForHotel
{
	partial class Unsettling
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Text = "Выселить";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(106, 407);
			...
			this.label1.Text = "Текущие заселения:";
			// 
			// button1
			// 
			...
			this.Name = "Unsettling";
			this.Text = "Выселение";
			this.Load += new System.EventHandler(this.Unsettling_Load);
