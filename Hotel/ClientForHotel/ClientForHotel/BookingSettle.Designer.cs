namespace ClientForHotel
{
	partial class BookingSettle
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(107, 404);
			...
			this.Name = "BookingSettle";
			this.Text = "Заселение по брони";
			this.Load += new System.EventHandler(this.BookingSettle_Load);
