namespace ClientForHotel
{
	partial class MenuGuest
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Text = "Информация о номерах";
			...
			this.button3.Text = "Информация о бронях";
			...
			this.button5.Text = "Отменить бронь";
			...
			this.Load += new System.EventHandler(this.MenuGuest_Load);
